...
public final class BooksLending_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
            ...
            String noc2 ="select book_id from library.book";
             ...
             out.println("<tr><td>Enter the Card No</td><td> <input type=number name=cno></td></tr>");
             ...
             out.println("<tr><td>Select the Issue Date</td><td><input type=date name=idate></td></tr>");
               out.println("<tr><td>Select the Due Date</td><td><input type=date name=ddate></td></tr>");
             out.println("</table>");
             out.println("<br>");
